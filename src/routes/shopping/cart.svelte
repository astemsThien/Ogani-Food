<script>
    import bread from '../images/breadcrumb.jpg'
    import { cart } from '$lib/config/cart';
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    <h5>Cart Total</h5>
                    <ul>{#each $cart as product }
                        {#if product.quantity > 0}
                        <li>{product.name} <span>{product.price * product.quantity} đ</span></li>
                        {/if}
                        {/each}
